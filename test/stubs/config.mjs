...
// Semilla de migración: las pruebas de arranque comprueban que, con la base
// de datos (falsa) vacía, esto se copia solo a Firebase la primera vez.
export const SPOTIFY_CLIENT_IDS_SEMILLA = [{ id: "client_id_de_pruebas", nombre: "Grupo A" }];
